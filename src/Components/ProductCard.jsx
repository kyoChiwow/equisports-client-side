...
const ProductCard = ({ product }) => {
    ...
    return (
        <div>
            {/* Card Wrapping Div */}
            <div className="bg-base-200 rounded-xl flex flex-col items-center justify-center">
                {/* Image div */}
                ...
                <div className="mt-8 w-full">
                    <Link to={`/details/${_id}`}><button className="btn btn-warning w-full rounded-b-xl rounded-t-none">View Details</button></Link>
                </div>
                {/* View Details Button Div */}
            </div>
            {/* Card Wrapping Div */}
